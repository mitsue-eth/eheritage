    ...
    >
      ...
      <motion.g id='polygon'>
        <motion.polygon
          ...
          points='218.587 213.222 218.587 191.76 200 181.029 181.413 191.76 181.413 213.222 200 223.953 218.587 213.222'
        />
        <motion.polygon
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
          ...
          className={styles.polygons}
          points='218.471 256.325 218.471 234.863 199.884 224.132 181.298 234.863 181.298 256.325 199.884 267.056 218.471 256.325'
        />
        <motion.polygon
          initial={{ pathLength: 0 }}
          animate={{ pathLength: 1 }}
      ...
      <motion.g id='text'>
        ...
        <motion.path
          ...
          animate='end'
          className={styles.text}
          d='m128.227,304.124h2.7v15.251h21.001v-15.251h2.7v35.002h-2.7v-17.251h-21.001v17.251h-2.7v-35.002Z'
        />
        <motion.path
          variants={textVariants}
          initial='start'
          animate='end'
          className={styles.text}
          d='m165.377,326.925c.05,6.451,3.3,10.451,8.101,10.451,4.7,0,6.3-2.65,7.2-4.7h2.55c-1.05,3.3-3.7,7.05-9.85,7.05-7.601,0-10.551-6.55-10.551-12.9,0-7.15,3.55-13.301,10.851-13.301,7.701,0,10.151,6.65,10.151,11.351,0,.7,0,1.4-.05,2.05h-18.401Zm15.851-2.2c-.05-4.95-2.75-8.85-7.65-8.85-5.15,0-7.5,3.6-8.05,8.85h15.701Z'
        />
        <motion.path
          variants={textVariants}
          initial='start'
          animate='end'
          className={styles.text}
          d='m191.127,320.925c0-4.2-.051-6-.051-6.801h2.45c.051.801.101,2.4.101,5.601,1.45-3.75,4.65-6,8.7-6.2v2.7c-5.2.35-8.7,3.95-8.7,9.9v13.001h-2.5v-18.201Z'
        />
        <motion.path
          variants={textVariants}
          initial='start'
          animate='end'
          className={styles.text}
          d='m208.127,302.273h2.5v4.851h-2.5v-4.851Zm0,11.851h2.5v25.002h-2.5v-25.002Z'
        />
        <motion.path
          variants={textVariants}
          initial='start'
          animate='end'
          className={styles.text}
          d='m216.625,314.124h4.65v-7.8h2.5v7.8h5.951v2.351h-5.951v16.251c0,2.8.601,4.4,3.001,4.4.75,0,1.8-.05,2.6-.3v2.2c-.85.35-2.05.449-3.1.449-3.2,0-5.001-1.6-5.001-5.6v-17.401h-4.65v-2.351Z'
        />
        <motion.path
          variants={textVariants}
          initial='start'
        ...
        <motion.path
          ...
          animate='end'
          className={styles.text}
          d='m281.726,337.426c0,8.001-3.55,12.201-10.801,12.201-6.5,0-9.2-3.65-9.8-7.451h2.55c.9,3.45,3.75,5.101,7.351,5.101,6.5,0,8.301-4.2,8.301-10.551v-2.6c-1.351,3.25-3.801,5-8.351,5-5.851,0-10.351-4.75-10.351-12.501,0-8.4,4.8-13.101,10.7-13.101,5.101,0,7.301,2.4,8.001,4.4.05-1.45.1-3.2.149-3.801h2.351c0,.9-.101,4.851-.101,7.251v16.051Zm-18.451-10.9c0,5.95,3.15,10.25,7.951,10.25,6.25,0,8.15-4.149,8.15-10.65,0-6.601-2-10.25-8.001-10.25-5.75,0-8.101,4.95-8.101,10.65Z'
        />
        <motion.path
          variants={textVariants}
          initial='start'
          animate='end'
          className={styles.text}
          d='m291.674,326.925c.05,6.451,3.3,10.451,8.101,10.451,4.7,0,6.3-2.65,7.2-4.7h2.55c-1.05,3.3-3.7,7.05-9.851,7.05-7.6,0-10.55-6.55-10.55-12.9,0-7.15,3.55-13.301,10.851-13.301,7.7,0,10.15,6.65,10.15,11.351,0,.7,0,1.4-.05,2.05h-18.401Zm15.851-2.2c-.05-4.95-2.75-8.85-7.65-8.85-5.15,0-7.5,3.6-8.05,8.85h15.7Z'
        />
      </motion.g>
